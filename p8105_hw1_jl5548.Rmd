...
```{r, eval=FALSE}
log2num = as.numeric(df$vec_logical) * df$vec_numeric
log2fac = as.factor(df$vec_logical) * df$vec_numeric
log2fac2num = as.numeric(as.factor(df$vec_logical)) * df$vec_numeric
```
